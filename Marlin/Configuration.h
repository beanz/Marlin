...
#define STRING_CONFIG_H_AUTHOR "(beanz, Metric Cerberus)" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "Cerberus"
...
#define DELTA_SMOOTH_ROD_OFFSET 195.25 // mm

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 33.5 // mm

// Horizontal offset of the universal joints on the carriages.
#define DELTA_CARRIAGE_OFFSET 39.5 // mm
...
// J-Head
    #define  DEFAULT_Kp 40.84
    #define  DEFAULT_Ki 3.35
    #define  DEFAULT_Kd 124.44

// E3D
//    #define  DEFAULT_Kp 13.41
//    #define  DEFAULT_Ki 0.75
//    #define  DEFAULT_Kd 59.53
...
#define MANUAL_Z_HOME_POS 570  // For delta: Distance between nozzle and print surface after homing.
...
#define XYZ_STEPS 68.82 // (XYZ_FULL_STEPS_PER_ROTATION * XYZ_MICROSTEPS / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH))

#define DEFAULT_AXIS_STEPS_PER_UNIT   {XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 773}
